...
const CorkageMap = () => {
  ...
  return (
    <main className="relative">
      <div className="absolute left-0 right-0 top-[6.57%] z-10">
        <TopBarMap searchDisabled={false} />
      </div>
      <div
        className="absolute left-[13%] top-[13.7%] z-10 flex h-[32px] w-[242px] cursor-pointer flex-row items-center justify-center gap-[7px] rounded-[20px] bg-white/85"
