...
function ChooseRole() {
  ...
  return (
    <main className="px-4 pt-[10vh]">
      ...
      <p className="text-2xl font-bold">{myProfile.nickname}님 반가워요!</p>
      <div className="mt-10 flex flex-col gap-5">
        <div
          className="flex h-[88px] cursor-pointer items-center justify-between rounded-2xl bg-[var(--gray-1)] px-4"
        ...
        <div
          className="flex h-[88px] cursor-pointer items-center justify-between rounded-2xl bg-top px-4"
